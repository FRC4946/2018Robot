...
public class ThreePointCurveDrive extends Command {
	...
	/**
	 * Uses three (x, y) coordinates to generate a circle encompassing all three
	 * points and drive along the generated curvature.
	 * 
	 * @param point1
	 *            The first point.
	 * @param point2
	 ...
	 *            The third point.
	 */
	public ThreePointCurveDrive(NDimensionalPoint point1, NDimensionalPoint point2, NDimensionalPoint point3,
			double speed) {
	...
	protected void initialize() {
		...
		// double slope1, slope2, yintercept1, yintercept2, midpointx1, midpointy1,
		// midpointx2,
		...
		//
		// point1to3dist = Math.sqrt(Math.pow(m_point3.getDimension(0) -
		// m_point1.getDimension(0), 2) +
	...
	protected boolean isFinished() {
		return false;
		// return (Robot.driveTrainSubsystem.getEncoderDistance() >= m_distInit +
		// m_distToGo);
	}
