...
public class TrapezoidMotionProfile {
	...
	public double getVel(double fDisGone) {
		...
		// Uses the acceleration setpoint to calculate a velocity setpoint based off the
		// current speed
	...
	public double fhan(double v1, double v2, double r0, double h0) {
		// from Han J. From PID to active disturbance rejection control[J]. IEEE
		// transactions on Industrial Electronics, 2009, 56(3): 900-906.
		double d = r0 * h0 * h0;
		double a0 = h0 * v2;
		double y = v1 + a0;
